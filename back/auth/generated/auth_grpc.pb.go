...
const (
	...
	AuthService_SingUp_FullMethodName  = "/auth.v1.AuthService/SingUp"
)
...
type AuthServiceClient interface {
	...
	SingUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*SignUpResponse, error)
}
...
func (c *authServiceClient) SingUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*SignUpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignUpResponse)
	err := c.cc.Invoke(ctx, AuthService_SingUp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	SingUp(context.Context, *SignUpRequest) (*SignUpResponse, error)
...
func (UnimplementedAuthServiceServer) SingUp(context.Context, *SignUpRequest) (*SignUpResponse, error) {
...
func _AuthService_SingUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SingUp(ctx, req.(*SignUpRequest))
	}
	return interceptor(ctx, in, info, handler)
}
